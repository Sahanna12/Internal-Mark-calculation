...
if ($con->connect_error) {
    ...
    // Check if the student's ID and name match the database records
    $student_query = "SELECT * FROM student WHERE sid=$id AND name='$name'";
    $student_result = mysqli_query($con, $student_query);
    if ($student_result->num_rows == 1) {
        // Display student details if the ID and name match
        ...
        echo "<table border='1'>";
        echo "<tr><th>SUBJECT</th><th>CO1</th><th>CO2</th><th>CO3</th><th>CO4</th><th>CO5</th><th>INTERNAL MARK</th></tr>";
            ...
            while ($subject_row = $subject_result->fetch_assoc()) {
                ...
                if ($marks_result->num_rows > 0) {
                    while ($marks_row = $marks_result->fetch_assoc()) {
                        ...
                        echo "<td>" . $marks_row['ut4'] . "</td>";
                        echo "<td>" . $marks_row['ut5'] . "</td>";
                        echo "<td>" . $marks_row['im'] . "</td>";
                        echo "</tr>";
                    }
                } else {
                    // If no marks found for the subject, display empty cells
                    echo "<tr><td>$subject_name</td><td></td><td></td><td></td><td></td><td></td><td></td></tr>";
                }
            }
        } else {
        ...
        // If the ID and name don't match, display an error message
        echo "<div class='center'>Incorrect student ID or name.</div>";
    }
}
?>
